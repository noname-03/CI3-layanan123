  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="form">
        ...
        <input name="id_masyarakat" id="id_masyarakat" cols="30" rows="10" class="form-control"></input>
      </div>

      <div class="form-group">
        <label for="no_tlp">No Telepon</label>
        <input name="no_tlp" id="no_tlp" cols="30" rows="10" class="form-control"></input>
      </div>

      <div class="form-group">
        <label for="alamat">Alamat</label>
        <input name="alamat" id="alamat" cols="30" rows="10" class="form-control"></input>
      </div>
