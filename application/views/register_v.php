         ...
         <div class="col-lg-7">
           <div class="p-5">
             ...
             <div class="form-group">
               <input type="text" class="form-control form-control-user" id="id_masyarakat" placeholder="Masukan id_masyarakat" name="id_masyarakat" value="<?= set_value('id_masyarakat') ?>">
             </div>
             <div class="form-group">
