...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
      ...
      <div class="sidebar-brand-text mx-3">Pelayanan PLN </div>
    </a>
    ...
    ?>
    <?php if ($this->session->userdata('username') && $this->session->userdata('level') == 'admin') : ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('Admin/PengaduanController'); ?>">Tulis Pengaduan</a>
          </div>
        </div>
      </li>
    <?php endif; ?>
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php if ($this->session->userdata('level') == 'admin') : ?>
              ...
              <a class="collapse-item" href="<?= base_url('Admin/MasyarakatController'); ?>">Data Masyarakat</a>
